//
//  ocpImagePickerViewController.m
//  Questions
//
...
#import "ocpImagePickerViewController.h"
#import "ocpViewController.h"

@interface ocpImagePickerViewController ()
...
@implementation ocpImagePickerViewController
...
- (void)finishAndUpdate
{
    ...
    if ([capturedImages count] > 0)
    {
        if ([capturedImages count] == 1)
        {
            ...
            [self.imageView setImage:[capturedImages objectAtIndex:0]];
        }
        else
        {
            // Camera took multiple pictures; use the list of images for animation.
            self.imageView.animationImages = capturedImages;
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    ocpViewController *controller = (ocpViewController *)navController;//.topViewController;
    controller.capturedImages = capturedImages;
}
